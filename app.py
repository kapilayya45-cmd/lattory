...
# --- Mee kotha Transparent PNG Links ikkada update chesa ---
CATEGORIES = {
    'low_cost': {
        'name': 'Budget Kings', 
        'model': 'Feature & Android Budget', 
        'specs': 'Reliable Battery | Dual Sim | Best for Daily Use',
        'price': 50, 
        'color': '#00f2ff',
        # PNGItem Link
        'image_url': 'https://pngitem.com'
    },
    'mid_range': {
...
<head>
    ...
    <style>
        ...
        .form-control { background: #1a1a1a !important; border: 1px solid #333 !important; color: #fff !important; border-radius: 12px !important; margin-bottom: 12px; padding: 12px; }
    ...
    <div class="container mt-5">
        {% with messages = get_flashed_messages() %}{% if messages %}{% for m in messages %}
            <div class="text-center p-4 mb-4" style="background:#111; border: 1px solid #28a745; border-radius:25px;">
                <h3 class="text-success fw-bold">TICKET CONFIRMED!</h3>
                <p>Scan QR & Send Screenshot to 9121195323</p>
        ...
        <div class="card-split">
            <div class="img-side">
                <img src="{{ info.image_url }}" referrerpolicy="no-referrer" onerror="this.src='https://placeholder.com...'" class="mobile-img">
            </div>
