...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'smart-win-ultra-final-v3'
...
<head>
    ...
    <style>
        ...
        .mobile-img { max-width: 100%; max-height: 350px; object-fit: contain; filter: drop-shadow(0 5px 15px rgba(0,0,0,0.1)); }
        ...
        /* Form Styling */
        .form-control { background: #1a1a1a; border: 1px solid #333; color: #fff; border-radius: 12px; margin-bottom: 12px; padding: 12px; }
        .form-control:focus { background: #222; border-color: #00f2ff; box-shadow: none; color: #fff; }
        
        .btn-buy { background: #fff; color: #000; font-weight: 800; border-radius: 12px; padding: 15px; border: none; width: 100%; text-transform: uppercase; transition: 0.3s; letter-spacing: 1px; }
...
def buy(cat):
    ...
    # Vercel bypass for flash message
